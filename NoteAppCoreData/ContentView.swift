            ...
            ZStack {
                ...
                VStack {
                    ...
                    if notesManager.notes.isEmpty {
                        ...
                        notesListView
                            .padding(.bottom, 50) // Add bottom padding for List
                    }
                }
                
                // Add Button Overlapping the List
                VStack {
                    Spacer()
                    addButton
                }
        ...
        List {
            ForEach(notesManager.notes) { note in
                NoteCellView(note: note, notesManager: notesManager)
                    ...
                    .listRowInsets(EdgeInsets(top: 0, leading: 24, bottom: 25, trailing: 24)) // Add insets
            }
